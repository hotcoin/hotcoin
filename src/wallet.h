...
public:
	...
	bool AddToWalletIfInvolvingMe(const uint256 &hash, const CMerkleTx& tx, const CBlock* pblock, bool fUpdate = false, bool fFindBlock = false);

    bool EraseFromWallet(uint256 hash);
    void WalletUpdateSpent(const CMerkleTx& prevout);	//void WalletUpdateSpent(const CTransaction& prevout);
